...
class FundDetailActivity extends StatefulWidget {
  final String fundCode;

  const FundDetailActivity({Key key, this.fundCode}) : super(key: key);

  @override
  _FundDetailActivityState createState() => _FundDetailActivityState();
}

class _FundDetailActivityState extends State<FundDetailActivity> {
  final Completer<WebViewController> _controller = Completer<WebViewController>();

  @override
  Widget build(BuildContext context) {
    // http://fund.eastmoney.com/270002.html?spm=search
    return Scaffold(
      appBar: AppBar(
